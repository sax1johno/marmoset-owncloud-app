<?php
/**
 * @copyright 2020, John O'Connor <sax1johno@gmail.com>
 *
 * @author John O'Coonnor <sax1johno@gmail.com>
 *
 ...
 *
 */
namespace OCA\MarmosetViewer\Controller;
...
class PublicFileHandlingController extends Controller{
    ...
    /**
     * load share marmoset viewer file by path
     *
     * @NoAdminRequired
     * @PublicPage
     * @NoCSRFRequired
